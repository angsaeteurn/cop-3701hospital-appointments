...
LINES TERMINATED BY '\n'
IGNORE 1 ROWS
(patient_id, patient_firstname, patient_lastname, gender, @dob)
...
-- ---------------- Medical History ----------------
LOAD DATA LOCAL INFILE 'data/medical_history.csv'
INTO TABLE MedicalHistory
FIELDS TERMINATED BY ','
ENCLOSED BY '"'
LINES TERMINATED BY '\n'
IGNORE 1 ROWS
(patient_id, @diagnosis_date, is_chronic)
SET diagnosis_date = STR_TO_DATE(@diagnosis_date, '%Y-%m-%d');

-- ---------------- Appointment Features ----------------
LOAD DATA LOCAL INFILE 'data/appointment_features.csv'
INTO TABLE AppointmentFeatures
FIELDS TERMINATED BY ','
ENCLOSED BY '"'
LINES TERMINATED BY '\n'
IGNORE 1 ROWS
(appointment_id, days_since_last_visit, sms_received, no_show_count);

-- ---------------- Doctor Availability ----------------
LOAD DATA LOCAL INFILE 'data/doctor_availability.csv'
